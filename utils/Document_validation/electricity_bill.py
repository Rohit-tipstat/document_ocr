...
def extract_event_information(text: str) -> Optional[dict]:
    ...
    try:
        ...
        prompt ="""Aim: To analyse the information and extract the right informations.
               ...
               You need to analyse the reframed data to see if the text is of an electricity bill or not.
               Also, you need to detect the owner name, address of the resident, pincode, meter number and the date of the bill.
