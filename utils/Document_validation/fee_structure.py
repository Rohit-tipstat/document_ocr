...
def extract_event_information(text: str) -> Optional[dict]:
    ...
    try:
        ...
        prompt ="""Aim: To analyse the information and extract the right informations.
               ...
               You need to analyse the reframed data to see if the text is of a fee structure letter or not.
               Also, you need to detect the student name, college name, fee amount and the date of document was made.
        ...
        response = chat(
            ...
            model="llama3.3:70b",
            format=fee_structure.model_json_schema(),
            options={'temperature': 0.2},
        )

        # Parse and validate the response
        output_json = fee_structure.model_validate_json(response.message.content)
