...
def extract_event_information(text: str) -> Optional[dict]:
    ...
    try:
        ...
        prompt ="""Aim: To analyse the information and extract the right informations.
               ...
               You need to analyse the reframed data to see if the text is of a Secondary School Certificate(10th class) marksheet or not.
               Also, you need to detect the student name, total_marks, board, percentage, cgpa, start year and passing year from the text. 
